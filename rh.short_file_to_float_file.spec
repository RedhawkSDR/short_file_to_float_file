# RPM package for short_file_to_float_file
...
%__install -m 644 short_file_to_float_file.sad.xml $RPM_BUILD_ROOT%{_prefix}/dom/waveforms/%{name}/short_file_to_float_file.sad.xml

%files
%defattr(-,redhawk,redhawk)
%dir %{_prefix}/dom/waveforms/%{name}
%{_prefix}/dom/waveforms/%{name}/short_file_to_float_file.sad.xml
